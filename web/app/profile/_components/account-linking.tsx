    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="grid gap-3">
          {SUPPORTED_AUTH_PROVIDERS.filter(
            provider =>
...
function AccountCard({
  ...
  const providerDetails = SUPPORTED_AUTH_PROVIDER_DETAILS[
    provider as SupportedAuthProvider
  ] ?? {
    name: provider,
    Icon: Shield,
  }
  ...
  function linkAccount() {
    if(provider === 'steam')  {
      return authClient.linkSteamAccount({
